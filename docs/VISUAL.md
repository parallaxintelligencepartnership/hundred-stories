...
- shafts: `#d8dbe0` rails on `#3b3f47` cavity, cars `#f0c419` with a `#c09d14` shadow face, two door panels on a dark door line, a `#fff3b0` ceiling light strip and a 30 percent `#fff3b0` fill in the cavity (the car is always lit), a 2 px `#3b3f47` cable to the top of the shaft, and a 4 px shadow cast up the shaft at 25 percent
