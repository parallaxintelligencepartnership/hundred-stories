...
npm test          # vitest run: 611 tests, 34 files
...
- Return target for this ship: `git checkout ship-2026-09-20b`. Previous good state: `ship-2026-09-20`, rehearsed at this closeout (checked out, built, returned).
